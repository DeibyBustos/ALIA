...
- "consulta_general": Pregunta general sobre el sistema académico (usa esta SOLO si no encaja en ninguna otra)

IMPORTANTE:
- Si pregunta "cuántos estudiantes hay de X" o "qué estudiantes hay en X" → usa "consultar_estudiantes_grado"
