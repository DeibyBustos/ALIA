 ...
 * Por defecto: ../storage (carpeta a la par del backend)
 */
export const STORAGE_FS_BASE =
  process.env.STORAGE_FS_BASE || path.resolve(process.cwd(), "../storage");

/**
 * Prefijo que guardamos en BD (relativo)
 * Ej: 'storage/AAAA-MM/archivo.ext'
 */
 ...
 * - rutaFS:  '<FS_BASE>/YYYY-MM/<ts>-<slug><ext>' (ABSOLUTA) -> para guardar en disco
 */
