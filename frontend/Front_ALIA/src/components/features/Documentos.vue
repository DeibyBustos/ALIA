        ...
        <div class="modal-panel">
          ...
          <div class="modal-header">
            ...
            <div class="modal-actions">
              <a
                :href="`${base}/documentos/${docSeleccionado.id}/descarga`"
              ...
              <div class="preview-excel-wrap">
                ...
                <div class="excel-table-wrap">
                  <table class="excel-table" v-if="previewTablas[hojaActiva]?.filas?.length">
                    <thead>
                      <tr>
                        <th v-for="(celda, ci) in previewTablas[hojaActiva].filas[0]" :key="ci">
                          {{ celda }}
                        </th>
                      </tr>
                    </thead>
...
function mkIcon(paths, col = "currentColor") {
  return defineComponent({
    render: () => h("svg",
      { width: 20, height: 20, viewBox: "0 0 24 24", fill: "none", stroke: col, "stroke-width": "1.7",
...
.preview-word-body td,
.preview-word-body th { border: 1px solid #ddd; padding: 6px 10px; font-size: 13px; }
.preview-word-body th { background: #f0f0f0; font-weight: 600; }
.preview-word-body ul,
.preview-word-body ol { padding-left: 24px; margin: 0 0 10px; }
